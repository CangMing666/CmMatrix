    ...
    public static class Builder {
        ...
        public MMonitor build() {
            ...
            MUploadService.Info info = new MUploadService.Info(context, MasData.getDeviceId(context)
                    , pkgName, appkey, appSecret, appVer, BuildConfig.SDK_VERSION, path,
